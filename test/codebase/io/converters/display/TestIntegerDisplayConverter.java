...
public class TestIntegerDisplayConverter extends
        TestCase {
    ...
    public void testReadMaxValue() throws IOException {
        IntegerDisplayConverter c = new IntegerDisplayConverter();
        final Integer i = (Integer) c.read(getDataInputFor(Integer.valueOf(Integer.MAX_VALUE)
                .toString()));
    ...
    public void testReadMinValue() throws IOException {
        IntegerDisplayConverter c = new IntegerDisplayConverter();
        final Integer i = (Integer) c.read(getDataInputFor(Integer.valueOf(Integer.MIN_VALUE)
                .toString()));
