...
public class TestFilenames extends
    ...
    public void testNormalize() throws Exception {
        ...
        assertEquals("~user" + SEP + "a" + SEP + "b" + SEP + "d",
                Filenames.normalize("~user/a/b//d"));
    ...
    public void testNormalizeNoEndSeparator() throws Exception {
        ...
        assertEquals(SEP + "a" + SEP + "b" + SEP + "d",
                Filenames.normalizeNoEndSeparator("/a/b//d"));
        ...
        assertEquals("~" + SEP + "a" + SEP + "d",
                Filenames.normalizeNoEndSeparator("~/a/b/../c/../d"));
        assertEquals("~" + SEP + "a" + SEP + "b" + SEP + "d",
                Filenames.normalizeNoEndSeparator("~/a/b//d"));
        assertEquals("~" + SEP + "a" + SEP + "b", Filenames.normalizeNoEndSeparator("~/a/b/././."));
        assertEquals("~" + SEP + "a", Filenames.normalizeNoEndSeparator("~/./a"));
        ...
        assertEquals("~user" + SEP + "a" + SEP + "c",
                Filenames.normalizeNoEndSeparator("~user/a/b/../c"));
        ...
        assertEquals("~user" + SEP + "a" + SEP + "d",
                Filenames.normalizeNoEndSeparator("~user/a/b/../c/../d"));
        assertEquals("~user" + SEP + "a" + SEP + "b" + SEP + "d",
                Filenames.normalizeNoEndSeparator("~user/a/b//d"));
        assertEquals("~user" + SEP + "a" + SEP + "b",
                Filenames.normalizeNoEndSeparator("~user/a/b/././."));
        assertEquals("~user" + SEP + "a", Filenames.normalizeNoEndSeparator("~user/./a"));
        ...
        assertEquals("C:" + SEP + "a" + SEP + "d",
                Filenames.normalizeNoEndSeparator("C:/a/b/../c/../d"));
        assertEquals("C:" + SEP + "a" + SEP + "b" + SEP + "d",
                Filenames.normalizeNoEndSeparator("C:/a/b//d"));
        assertEquals("C:" + SEP + "a" + SEP + "b",
                Filenames.normalizeNoEndSeparator("C:/a/b/././."));
        assertEquals("C:" + SEP + "a", Filenames.normalizeNoEndSeparator("C:/./a"));
        ...
        assertEquals(SEP + SEP + "server" + SEP + "a",
                Filenames.normalizeNoEndSeparator("//server/a"));
        assertEquals(SEP + SEP + "server" + SEP + "a",
                Filenames.normalizeNoEndSeparator("//server/a/"));
        assertEquals(SEP + SEP + "server" + SEP + "a" + SEP + "c",
        ...
        assertEquals(SEP + SEP + "server" + SEP + "a",
                Filenames.normalizeNoEndSeparator("//server/./a"));
        assertEquals(SEP + SEP + "server" + SEP + "",
                Filenames.normalizeNoEndSeparator("//server/./"));
        assertEquals(SEP + SEP + "server" + SEP + "",
                Filenames.normalizeNoEndSeparator("//server/."));
    ...
    public void testRemoveExtension() {
        ...
        assertEquals("C:\\temp\\foo.bar\\README",
                Filenames.removeExtension("C:\\temp\\foo.bar\\README"));
    ...
    public void testEquals() {
        ...
        assertEquals(false, Filenames.equals("a\\b\\file.txt", "a/b/file.txt"));
    }
    ...
    public void testEqualsOnSystem() {
        ...
        assertEquals(false, Filenames.equalsOnSystem("a\\b\\file.txt", "a/b/file.txt"));
    }
    ...
    public void testEqualsNormalized() {
        ...
        assertEquals(true, Filenames.equalsNormalized("file.txt", "file.txt"));
        assertEquals(false, Filenames.equalsNormalized("file.txt", "FILE.TXT"));
        assertEquals(true, Filenames.equalsNormalized("a\\b\\file.txt", "a/b/file.txt"));
    ...
    public void testEqualsNormalizedOnSystem() {
        ...
        assertEquals(true, Filenames.equalsNormalizedOnSystem("file.txt", "file.txt"));
        assertEquals(WINDOWS, Filenames.equalsNormalizedOnSystem("file.txt", "FILE.TXT"));
        assertEquals(true, Filenames.equalsNormalizedOnSystem("a\\b\\file.txt", "a/b/file.txt"));
        assertEquals(false, Filenames.equalsNormalizedOnSystem("a/b/", "a/b"));
    }

    // -----------------------------------------------------------------------
    public void testIsExtension() {
        assertEquals(false, Filenames.isExtension(null, (String) null));
        assertEquals(false, Filenames.isExtension("file.txt", (String) null));
        ...
        assertEquals(false, Filenames.isExtension("a/b/file.txt", (String) null));
    ...
    public void testIsExtensionArray() {
        ...
        assertEquals(false, Filenames.isExtension("file.txt", (String[]) null));
        assertEquals(true, Filenames.isExtension("file", (String[]) null));
        assertEquals(false, Filenames.isExtension("file.txt", new String[0]));
        assertEquals(true, Filenames.isExtension("file.txt", new String[] { "txt" }));
        assertEquals(false, Filenames.isExtension("file.txt", new String[] { "rtf" }));
        assertEquals(true, Filenames.isExtension("file", new String[] { "rtf", "" }));
        assertEquals(true, Filenames.isExtension("file.txt", new String[] { "rtf", "txt" }));

        assertEquals(false, Filenames.isExtension("a/b/file.txt", (String[]) null));
        assertEquals(false, Filenames.isExtension("a/b/file.txt", new String[0]));
        assertEquals(true, Filenames.isExtension("a/b/file.txt", new String[] { "txt" }));
        assertEquals(false, Filenames.isExtension("a/b/file.txt", new String[] { "rtf" }));
        assertEquals(true, Filenames.isExtension("a/b/file.txt", new String[] { "rtf", "txt" }));
        ...
        assertEquals(false, Filenames.isExtension("a.b\\file.txt", new String[] { "TXT" }));
        assertEquals(false, Filenames.isExtension("a.b\\file.txt", new String[] { "TXT", "RTF" }));
    }

    public void testIsExtensionCollection() {
        assertEquals(false, Filenames.isExtension(null, (Collection<String>) null));
        assertEquals(false, Filenames.isExtension("file.txt", (Collection<String>) null));
        assertEquals(true, Filenames.isExtension("file", (Collection<String>) null));
        assertEquals(false, Filenames.isExtension("file.txt", new ArrayList<String>()));
        assertEquals(
                true,
                Filenames.isExtension("file.txt",
        ...
        assertEquals(false, Filenames.isExtension("a/b/file.txt", (Collection<String>) null));
        assertEquals(false, Filenames.isExtension("a/b/file.txt", new ArrayList<String>()));
        assertEquals(
                true,
                Filenames.isExtension("a/b/file.txt",
                        new ArrayList<String>(Arrays.asList(new String[] { "txt" }))));
        assertEquals(
                false,
                Filenames.isExtension("a/b/file.txt",
