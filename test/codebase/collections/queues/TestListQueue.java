...
/**
 * Unit tests for the {@link codebase.collections.queues.ListQueue} class.
 */
public class TestListQueue
    ...
    public final void testBaseEnqueueDequeue() {
        BaseQueueTests.testEnqueueDequeue(new ListQueue());
    }
    ...
    public final void testIsEmpty() {
        BaseQueueTests.testIsEmpty(new ListQueue());
    }
    ...
    public final void testClear() {
        BaseQueueTests.testClear(new ListQueue());
    }
    ...
    public final void testPeek() {
        BaseQueueTests.testPeek(new ListQueue());
    }
     ...
     */
    public void testSizeIncreaseDecrease() {
        BaseQueueTests.testSizeIncreaseDecrease(new ListQueue());
    }
    ...
    public final void testSizeClear() {
        BaseQueueTests.testSizeClear(new ListQueue());
    }
    ...
    public final void testSizePeekInvariance() {
        BaseQueueTests.testSizePeekInvariance(new ListQueue());
    }
    ...
    /**
     * Tests the FIFO behavior of the list queue.
     *
     * @see FIFOQueueTests#testFIFOBehavior(Queue)
     */
    public final void testFIFOBehavior() {
        FIFOQueueTests.testFIFOBehavior(new ListQueue());
    }
}
