...
public class TestBinary
    ...
    public void testToInteger() {
        assertEquals(0, Binary.toInteger((byte) 0, (byte) 0, (byte) 0,
            (byte) 0));
        assertEquals(1, Binary.toInteger((byte) 1, (byte) 0, (byte) 0,
            (byte) 0));
        assertEquals(256, Binary.toInteger((byte) 0, (byte) 1, (byte) 0,
            (byte) 0));
        assertEquals(65536, Binary.toInteger((byte) 0, (byte) 0, (byte) 1,
            (byte) 0));
        assertEquals(0x78563412, Binary.toInteger((byte) 0x12, (byte) 0x34,
            (byte) 0x56, (byte) 0x78));
    }
    ...
    public void testToHexString() {
        ...
        assertEquals("1234567890abcdef", Binary.toHexString(new byte[] {
                0x12, 0x34, 0x56, 0x78, (byte) 0x90, (byte) 0xAB,
                (byte) 0xCD, (byte) 0xEF}));
    }
    ...
    public void testDecodeIntegersToBytes() {
        ...
        assertEquals(EmptyIterator.DEFAULT_INSTANCE, new ArrayIterator(Arrays
            .toByteArray(Binary.decodeIntegersToBytes(input1, 0))));

        // with one integer
        final int[] input2 = new int[] {7};
        assertEquals(new ArrayIterator(new Byte[] {
                new Byte((byte) 7), new Byte((byte) 0), new Byte((byte) 0),
                new Byte((byte) 0)}), new ArrayIterator(Arrays
            .toByteArray(Binary.decodeIntegersToBytes(input2, 4))));
        ...
        assertEquals(new ArrayIterator(new Byte[] {
                new Byte((byte) 7), new Byte((byte) 0), new Byte((byte) 0),
                new Byte((byte) 0), new Byte((byte) 0x78),
                new Byte((byte) 0x56), new Byte((byte) 0x34),
                new Byte((byte) 0x12)}), new ArrayIterator(Arrays
            .toByteArray(Binary.decodeIntegersToBytes(input3, 8))));
    }
    ...
    public void testEncodeBytesToIntegers() {
        ...
        assertEquals(EmptyIterator.DEFAULT_INSTANCE, new ArrayIterator(Arrays
            .toIntegerArray(Binary.encodeBytesToIntegers(input1, 0, 0))));

        // with one integer
        final byte[] input2 = new byte[] {
                (byte) 7, (byte) 0, (byte) 0, (byte) 0};
        assertEquals(new ArrayIterator(new Integer[] {new Integer(7)}),
            new ArrayIterator(Arrays.toIntegerArray(Binary
                .encodeBytesToIntegers(input2, 0, 4))));

        // with two integers
        final byte[] input3 = new byte[] {
                (byte) 7, (byte) 0, (byte) 0, (byte) 0, (byte) 0x78,
                (byte) 0x56, (byte) 0x34, (byte) 0x12};

        assertEquals(new ArrayIterator(new Integer[] {
                new Integer(7), new Integer(0x12345678)}),
            new ArrayIterator(Arrays.toIntegerArray(Binary
                .encodeBytesToIntegers(input3, 0, 8))));
    }
}
