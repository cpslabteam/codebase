...
public class TestEnumerator
    ...
    public final void testOne() {
        assertEquals(new ArrayIterator<Object>(new Object[] {new Integer(0)}),
            new Enumerator(0, 1));
        assertEquals(new ArrayIterator<Object>(new Object[] {new Integer(0)}),
            new Enumerator(0, -1));
        assertEquals(new ArrayIterator<Object>(new Object[] {new Integer(1)}),
            new Enumerator(1, 2));
        assertEquals(new ArrayIterator<Object>(new Object[] {new Integer(-1)}),
            new Enumerator(-1, -2));
        assertEquals(new ArrayIterator<Object>(new Object[] {new Integer(7)}),
            new Enumerator(7, 8));
        assertEquals(new ArrayIterator<Object>(new Object[] {new Integer(-7)}),
            new Enumerator(-7, -8));
    }
    ...
    public final void testMultiple() {
        assertEquals(new ArrayIterator<Object>(new Object[] {
