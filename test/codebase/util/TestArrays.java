...
public class TestArrays
    ...
    public void testAddLongs() {
        ...
        assertEquals(new long[] { 1L, 7L, 3L }, Arrays.add(
            new long[] { 1L, 7L }, 3L));
    }
    ...
    public void testRemoveIntegers() {
        ...
        assertEquals(new int[] { 1, 7 }, Arrays
            .remove(3, new int[] { 1, 3, 7 }));
    }
    
    public void testRemoveLongs() {
        assertEquals(new long[] {}, Arrays.remove(1L, new long[] { 1L }));
        
        assertEquals(new long[] { 1L }, Arrays
            .remove(2L, new long[] { 1L, 2L }));
        
        assertEquals(new long[] { 1L }, Arrays.remove(2L, new long[] { 1L, 2L,
                2L }));
        
        assertEquals(new long[] { 1L, 7L }, Arrays.remove(3L, new long[] { 1L,
                3L, 7L }));
    }
    ...
    public void testEquals() {
        ...
        // singleton
        assertTrue(Arrays.equals(new Object[] { new Integer(7) },
            new Object[] { new Integer(7) }));
        
        // pairs
        assertTrue(Arrays.equals(
            new Object[] { new Integer(1), new Integer(7) }, new Object[] {
                    new Integer(1), new Integer(7) }));
        
        // generic
        assertTrue(Arrays.equals(new Object[] { new Integer(2), new Integer(3),
                new Integer(7) }, new Object[] { new Integer(2),
                new Integer(3), new Integer(7) }));
        ...
        // different sizes
        assertTrue(!Arrays.equals(
            new Object[] { new Integer(7), new Integer(9) }, new Object[] {
                    new Integer(9), new Integer(7) }));
        
        // Exchanged
        assertTrue(!Arrays.equals(
            new Object[] { new Integer(7), new Integer(7) },
            new Object[] { new Integer(7) }));
    ...
    public void testComplement() {
        ...
        // singleton with void
        assertEquals(new int[] { 1 }, Arrays.minus(new int[] { 1 },
            new int[] {}));
        ...
        assertEquals(new int[] {}, Arrays.minus(new int[] { 1 },
            new int[] { 1 }));
        ...
        // generic
        assertEquals(new int[] { 1, 2, 3 }, Arrays.minus(
            new int[] { 1, 2, 3, 4 }, new int[] { 4, 5 }));
    }
    ...
    public void testIntersect() {
        ...
        // singleton with void
        assertEquals(new int[] {}, Arrays.intersect(new int[] { 1 },
            new int[] {}));
        ...
        // singleton with singleton
        assertEquals(new int[] { 1 }, Arrays.intersect(new int[] { 1 },
            new int[] { 1 }));
        ...
        // generic
        assertEquals(new int[] { 2, 4 }, Arrays.intersect(new int[] { 1, 2, 3,
                4, 5 }, new int[] { 2, 4 }));
    }
    ...
    public void testUnique() {
        ...
        assertEquals(new int[] { 1, 2, 3 }, Arrays.unique(new int[] { 1, 2, 1,
                3, 1, 2, 1 }));
    }
    ...
    public void testFlatten() {
        ...
        assertEquals(new Object[] { o1, o2 }, Arrays.flatten(new Object[] { o1,
                o2 }));
        
        assertEquals(new Object[] { o1, o2 }, Arrays.flatten(new Object[] {
                new Object[] {}, o1, new Object[] {}, o2, new Object[] {} }));
        
        final Object o3 = new Object();
        assertEquals(new Object[] { o1, o2, o3 }, Arrays.flatten(new Object[] {
                o1, o2, new Object[] { o3 } }));
        
        final Object ox = new Object();
        final Object o4 = new Object();
        final Object o5 = new Object();
        assertEquals(new Object[] { ox, o1, ox, o2, o3, o4, o5 }, Arrays
            .flatten(new Object[] { new Object[] { ox }, o1,
                    new Object[] { ox }, o2, new Object[] { o3, o4, o5 } }));        
    }
    
    public void testFindNotNullIndices() {
        assertEquals(new int[] {}, Arrays.findNotNullIndices(new Object[] {}));
        
        assertEquals(new int[] {}, Arrays
            .findNotNullIndices(new Object[] { null }));
        
        assertEquals(new int[] { 0 }, Arrays
            .findNotNullIndices(new Object[] { new Object() }));
        
        assertEquals(new int[] {}, Arrays.findNotNullIndices(new Object[] {
                null, null, null, null }));
        
        assertEquals(new int[] { 0 }, Arrays.findNotNullIndices(new Object[] {
                new Object(), null }));
        
        assertEquals(new int[] { 1 }, Arrays.findNotNullIndices(new Object[] {
                null, new Object() }));
        
        assertEquals(new int[] { 0, 1 }, Arrays
            .findNotNullIndices(new Object[] { new Object(), new Object() }));
        
        assertEquals(new int[] { 1, 2, 4 }, Arrays
            .findNotNullIndices(new Object[] { null, new Object(),
