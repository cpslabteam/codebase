 ...
 * <p>
 * <b>Note: </b> In case we have an array of primitive types have to first convert it into
 * the corresponding array of Objects. This array of objects can then be used to feed the
 * iterator.
 * 
...
public class ArrayIterator<E> extends AbstractArrayIterator<E>
     ...
     * @throws IllegalArgumentException if the array is in fact <code>null</code>
     */
