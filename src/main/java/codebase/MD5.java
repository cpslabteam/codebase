 ...
 * <p>
 * <b>Note</b> that for security critical applications MD5 should not be used. Instead use
 * SHA1.
 * <p>
...
public final class MD5 {
    ...
    private static final class MD5Funcs {
        ...
        /*
         * Checkstyle complains about constants and about the function names of the MD5
         * algorithm below. Fixing this would make the code less readable.
         */
        private static final byte[] PADDING = { (byte) 0x80, (byte) 0, (byte) 0, (byte) 0, (byte) 0,
    ...
    public static String getDigest(final String s) {
        final String hexDigest = BinaryUtil.toHexString(getDigestRaw(s, StringUtil.UTF8));
        return hexDigest;
    }
     ...
     * @return An instance of String, with the MD5 result of a message.
     */
    public static String getDigest(final String s, final Charset encoding) {
     ...
     */
    public static final byte[] getDigestRaw(final String s, final Charset encoding) {
        byte[] bytes = null;
