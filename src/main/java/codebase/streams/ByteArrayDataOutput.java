...
public class ByteArrayDataOutput implements DataOutput {
    ...
    static int writeUTF(String str, DataOutput out) throws IOException {
        ...
        // CHECKSTYLE:OFF
        /*
         * uses the byte limits for UTF to determine the length in bytes of the utf
         * message
         */
    ...
    /**
     * Creates a new data output that will write to a given byte array.
     * 
     * @param data the array to send the bytes to; cannot be <code>null</code>
     */
