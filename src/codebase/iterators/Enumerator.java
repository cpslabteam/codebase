 ...
 * <p>
 * Returns an ascending or descending sequence of integer objects within a given
 * range.
 * <p>
 * There are three different ways to generate integer objects with an
 * enumerator:
 * <ul>
 * <li>Specifying a range, i.e., the start-position and end-position are user
 * defined.</li>
 * <li>Specifying only the end-position; In this way <i>start</i>=<i>0</i>.
 * </li>
 ...
 * depending on the given start- and end-position.
 * <p>
 * <b>Note: </b> that the start-position of the integer sequence will be
 * returned by the enumerator, but not the end-position. So only the integer
 * elements of the interval [<i>start</i>,<i>end</i>) will be returned by
 * the enumerator.
 * 
...
public final class Enumerator
    ...
    /**
     * The int value returned by the next call to <tt>next</tt> or
     * <tt>peek</tt>.
     */
     ...
     * <p>
     * In other words, returns <code>true</code> if {@link #next()} if the
     * enumeration has not been exhausted
     * 
     ...
     * <p>
     * When {@link #next()} is called for the first time the value returned is
     * the start value in the constructor. The next value is computed by adding
     * or subtracting to the last returned element, respectively if, the limit
     * is greater or lower that the start.
     * 
     * @return an {@link Integer} object with the next element in the
     *         enumeration.
     */
    public Object next() {
     ...
     * 
     * @throws UnsupportedOperationException because it is not possible to
     *             remove elements from an enumerator iterator.
     */
     ...
     * @throws IllegalStateException when peeking an object past the upper bound
     *             of the enumerator
     */
