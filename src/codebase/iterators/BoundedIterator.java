 ...
 * <p>
 * This class bounds the number of elements returned by an iterator and it can
 * be used to set artificial limits on possible unbounded iterators. It
 * re-implements the method {@link Iterator#next()} adding limit checking. It
 * can be used decorator
 * 
 * @author Paulo Carreira
 */
public class BoundedIterator
     ...
     */
    public BoundedIterator(final Iterator instance, final int limit) {
        super(instance);
        if (limit < 0) {
     ...
     * 
     * @return <code>true</code> if the number of elements returned so far is
     *         smaller that the specified limit; returns <code>false</code>
     *         otherwise.
     */
     ...
     * <p>
     * If the <i>remove</i> operation of the decorated instance succeeds, then
     * the number of elelement returned so far is decremented.
     * 
     * @throws IllegalStateException if the number of elements returned so far
     *             is zero
     */
