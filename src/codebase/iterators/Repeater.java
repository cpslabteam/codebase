 ...
 * <p>
 * A limit in the number of times the element is repeated, <i>n</i>, is
 * specified in the constructor. The given element will be delivered by calls to
 * the {@link #next()} method. If a limit is not specified the same repeatable
 * will infinitely be returned to the caller.
 */
public final class Repeater
     ...
     */
    private final Object repeatable;
    ...
    /**
     * Creates a new repeater iteratorthat reiterates the input element only for
     ...
     */
    public Repeater(final Object object, final int n) {
        repeatable = object;
        initial = n;
        left = initial;
        unlimited = false;
     ...
     *            caller.
     */
    public Repeater(final Object object) {
     ...
     * 
     * @return <code>true</code> if the repeater is unlimited or if the the
     *         last element was not yet returned
     */
    ...
    /**
     * Returns another reference to the repeatable object specified in the
     * constructor.
     * 
     ...
     * <p>
     * If the sequence is unlimited does nothing, else decreses the number of
     * items left.
     * 
     ...
     * <p>
     * A repeater is read-only. If this was note the case, the implementation of
     * the repeater would be much more complex. It would be necessary to where
     * the repeat sequence was updated to handle {@link #reset()} adequatelly.
     * 
