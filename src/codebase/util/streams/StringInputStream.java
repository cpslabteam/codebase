 ...
 * <p>
 * Note that data will be lost for characters that are not ISO Latin 1. This
 * happens because a simple char to byte mapping is assumed.
 * <p>
 * This class was taken from the apache project.
 *
 * @author Original author: <a href="mailto:umagesh@apache.org">Magesh
 *         Umasankar </a>
...
public class StringInputStream
     ...
     * <p>
     * <b>Note:</b>Note that data will be lost for characters not reader ISO
     * Latin 1. Clients assuming a return value reader the range -1 to 255 may
     * even fail on such input.
     *
