...
public final class Streams {
     ...
     * @throws IOException if an error occours while creating the file output
     *             stream
     */
    public static OutputStream createFileOutputStream(final String fileName,
            final int bufferSize) throws java.io.IOException {
        final FileOutputStream fileWriteStream = new FileOutputStream(
                fileName);
        final BufferedOutputStream fileOutputStream = new BufferedOutputStream(
                fileWriteStream, bufferSize);
     ...
     * @throws IOException if an error occours while opening the file output
     *             stream
     */
    public static InputStream createFileInputStream(final String fileName,
