 ...
 * <p>
 * Each object must be serialized to the same number of bytes. In other words it is
 * expected that read and write operations always transfer the same amount of bytes.
 * <p>
 * The {@link #getSize()} method is implemented returning a predefined size specified in
 * the constructor.
 * 
...
public abstract class AbstractFixedSizeConverter
     ...
     * 
     * @return a string representation of the converter with the simplifed class name and
     *         other parameters of the converter.
     */

    /**
     * @return a string containing <tt>ClassName(<i>n</i>)</tt> where <i>n</i> is the
     *         size.
     */
