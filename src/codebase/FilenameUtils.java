...
public class FilenameUtils {
        ...
        if (len == 1) {
            ...
            if (ch0 == '~') {
                ...
                if (posUnix == -1 && posWin == -1) {
                    return len + 1; // return a length greater than the
                    // input
                }
    ...
    // -----------------------------------------------------------------------
    /**
     * Converts a filename extension wildcard string to a regular expression
     * (i.e. *.js into a regular expression matching all .js file names)
     * 
     * @param wildcardExpression the expression to convert
     * @param caseInsensitive do we make the expression case-insensitive
     * @return The modified expression
     */
    public static String wildcardToRegex(final String wildcardExpression,
        ...
        {
            return wildcardExpression.substring(1,
                wildcardExpression.length() - 1);
        }
     ...
     * on Dos/Unix command lines. The extension check is case-sensitive.
     * 
     * <pre>
     ...
     * @return true if the filename matches the wilcard string
     */
    private static boolean wildcardMatch(String filename,
            String wildcardMatcher, boolean system) {
