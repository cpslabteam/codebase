 ...
 * <p>
 * This class works by creating a lock file and then deleting the file when
 * shutting down. If the file exists when starting up this indicates that there
 * was a problem with the the last shutdown.
 */
public class CrashDetector {
	 ...
	 * <p>
	 * Note that clients of this class have the responsibility of defining the
	...
	public CrashDetector(final String directory) {
		lockFilePath = codebase.Filenames.concat(directory, CRASH_LOCK_FILE_NAME);
	}

	/**
	 * Checks if the last startup was clean.
	 * 
	 * @return <code>true</code> if the lock file does not exist and
	 *         <code>false</code> if a lock file exists.
	 * @throws IllegalStateException
	 *             if the startup method has already been called.
	 * @see #startup()
	 */
	 ...
	 * 
	 * @return <code>true</code> if the crash detector was able to create the
	 *         lock file. Returns <code>false</code> otherwise.
	 */
	 ...
	 * 
	 * @return <code>true</code> if the lock file was successfully removed.
	 *         Returns <code>false</code> if the lock file could not be removed.
	 * @throws IllegalStateException
	 *             if the startup method was not called yet
	 * @see #startup()
	 */
