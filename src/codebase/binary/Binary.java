...
public final class Binary {
    ...
    public static short swapShort(final short value) {
        return (short) ((((value >> 0) & INT_LOW_BYTE_MASK) << BITS_PER_BYTE) 
                + (((value >> BITS_PER_BYTE) & INT_LOW_BYTE_MASK) << 0));
    }
    ...
    public static void toByteArray(final int i, final byte[] output, final int offset) {
        ...
        output[offset + secondByteOffset] = (byte) ((i >> secondByteOffset * BITS_PER_BYTE) & INT_LOW_BYTE_MASK);
        output[offset + thirdByteOffset] = (byte) ((i >> thirdByteOffset * BITS_PER_BYTE) & INT_LOW_BYTE_MASK);
        output[offset + fourthByteOffset] = (byte) ((i >> fourthByteOffset * BITS_PER_BYTE) & INT_LOW_BYTE_MASK);
    }
    ...
    public static String toHex(final int i) {
        final char[] intChars = new char[] {
                HEX_DIGITS[(i >> BITS_FOR_FOUR_BYTES - BITS_PER_NIBBLE) & INT_BYTE_LOW_NIBBLE_MASK],
                HEX_DIGITS[(i >> BITS_FOR_THREE_BYTES) & INT_BYTE_LOW_NIBBLE_MASK],
                HEX_DIGITS[(i >> BITS_FOR_THREE_BYTES - BITS_PER_NIBBLE) & INT_BYTE_LOW_NIBBLE_MASK],
                HEX_DIGITS[(i >> BITS_FOR_TWO_BYTES) & INT_BYTE_LOW_NIBBLE_MASK],
                HEX_DIGITS[(i >> BITS_FOR_TWO_BYTES - BITS_PER_NIBBLE) & INT_BYTE_LOW_NIBBLE_MASK],
     ...
     * @return an integer where b0 is the least significan byte and b3 is the most
     *         significant byte
     */
