...
public final class SysUtil {
	...
	/**
	 * @return the name of the first COM (serial) port, or "???" if it can't be
	 *         determined
	 */
	 ...
	 * If the desktop folder path is not available, the user home will be
	 * returned.
	 * 
	 * @return path
	 */
	...
	/**
	 * Returns the application install path. WARNING: This information is
	 * obtained indirectly by finding the location of the the .class file for
	 * this class, and working back from there. This means that the function is
	 * not generic, and may need to be changed if the directory structure used
	...
	/**
	 * Joins the given path components into a path, using the appropriate
	 * separator for the system. The result does not contain an ending separator
	 * (unless the final component passed as an argument already contains it.)
	 * 
	 * @param components
	 *            Path components
