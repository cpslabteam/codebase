...
/**
 * Tests the {@link MD5} using the test suite defined in RFC1321.
 */
public class TestMD5 extends TestCase {
    ...
    public void testMD5() {
        ...
        assertEquals("F96B697D7CB7938D525A2F31AAF161D0",
                MD5.getDigest("message digest").toUpperCase());
        assertEquals("C3FCD3D76192E4007DFB496CCA67E13B",
                MD5.getDigest("abcdefghijklmnopqrstuvwxyz").toUpperCase());
        assertEquals("D174AB98D277D9F5A5611C2C9F419D9F",
                MD5.getDigest(
                        "ABCDEFGHIJKLMNOPQRSTUVWXYZ" + "abcdefghijklmnopqrstuvwxyz" + "0123456789")
                        .toUpperCase());
        assertEquals(
                "57EDF4A22BE3C955AC49DA2E2107B67A", MD5
                        .getDigest("12345678901234567890" + "1234567890" + "1234567890"
